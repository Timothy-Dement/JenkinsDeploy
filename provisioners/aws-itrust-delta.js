...
EC2.describeInstances(describeInstancesParams, function(err, data)
{
    ...
    else
    {
        ...
        else console.log('The iTrust-Delta server has already been provisioned\n');
    }
});
...
function provision()
{
    console.log('||||||||||||||||||||||||||||||||||||||||||||||||||||||');
    console.log('||||                                              ||||');
    console.log('||||    Beginning iTrust-Delta provisioning...    ||||');
    console.log('||||                                              ||||');
    console.log('||||||||||||||||||||||||||||||||||||||||||||||||||||||\n');

    var createKeyPairParams = { KeyName : 'iTrust-Delta' };
    ...
    EC2.createKeyPair(createKeyPairParams, function(err, data)
    {
        ...
        else
        {
            ...
            {
                Description : 'iTrust-Delta',
                GroupName : 'iTrust-Delta'
            };
                        ...
                        EC2.authorizeSecurityGroupIngress(authorizeSecurityGroupIngressParams, function(err, data)
                        {
                            ...
                            else
                            {
                                ...
                                var runInstanceParams =
                                {
                                    ...
                                    MinCount : 1,
                                    MaxCount : 1,
                                    KeyName : 'iTrust-Delta',
                                    SecurityGroups : [ 'iTrust-Delta' ]
                                };
                                    ...
                                    else
                                    {
                                        ...
                                        setTimeout(function()
                                        {
                                            var createTagsParams =
                                            {
                                                ...
                                                Tags : [ { Key : 'Name', Value : 'iTrust-Delta' } ]
                                            };
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            EC2.associateAddress(associateAddressParams, function(err, data)
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    fs.writeFile('/home/ubuntu/JenkinsDeploy/itrust-delta.key', privateKey, function(err)
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            fs.chmod('/home/ubuntu/JenkinsDeploy/itrust-delta.key', 0600, function(err)
                                                                            {
                                                                    ...
                                                                    if (fs.existsSync('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory'))
                                                                    {
                                                                        fs.open('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory', 'a', function(err)
                                                                        {
                                                                            ...
                                                                            inventoryItem += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-delta.key`;
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        inventory += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-delta.key`;
