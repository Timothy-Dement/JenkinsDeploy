...
EC2.describeInstances(describeInstancesParams, function(err, data)
{
    ...
    else
    {
        ...
        else console.log('The iTrust-Echo server has already been provisioned\n');
    }
});
...
function provision()
{
    ...
    EC2.createKeyPair(createKeyPairParams, function(err, data)
    {
        ...
        else
        {
            ...
            {
                Description : 'iTrust-Echo',
                GroupName : 'iTrust-Echo'
            };
                                    ...
                                    else
                                    {
                                        ...
                                        setTimeout(function()
                                        {
                                            var createTagsParams =
                                            {
                                                ...
                                                Tags : [ { Key : 'Name', Value : 'iTrust-Echo' } ]
                                            };
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            EC2.associateAddress(associateAddressParams, function(err, data)
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    fs.writeFile('/home/ubuntu/JenkinsDeploy/itrust-echo.key', privateKey, function(err)
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            fs.chmod('/home/ubuntu/JenkinsDeploy/itrust-echo.key', 0600, function(err)
                                                                            {
                                                                    ...
                                                                    if (fs.existsSync('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory'))
                                                                    {
                                                                        fs.open('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory', 'a', function(err)
                                                                        {
                                                                            ...
                                                                            inventoryItem += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-echo.key`;
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        inventory += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-echo.key`;
