...
EC2.describeInstances(describeInstancesParams, function(err, data)
{
    ...
    else
    {
        ...
        else console.log('The iTrust-Charlie server has already been provisioned\n');
    }
});
...
function provision()
{
    console.log('||||||||||||||||||||||||||||||||||||||||||||||||||||||||');
    console.log('||||                                                ||||');
    console.log('||||    Beginning iTrust-Charlie provisioning...    ||||');
    console.log('||||                                                ||||');
    console.log('||||||||||||||||||||||||||||||||||||||||||||||||||||||||\n');

    var createKeyPairParams = { KeyName : 'iTrust-Charlie' };
    ...
    EC2.createKeyPair(createKeyPairParams, function(err, data)
    {
        ...
        else
        {
            ...
            {
                Description : 'iTrust-Charlie',
                GroupName : 'iTrust-Charlie'
            };
                        ...
                        EC2.authorizeSecurityGroupIngress(authorizeSecurityGroupIngressParams, function(err, data)
                        {
                            ...
                            else
                            {
                                ...
                                var runInstanceParams =
                                {
                                    ...
                                    MinCount : 1,
                                    MaxCount : 1,
                                    KeyName : 'iTrust-Charlie',
                                    SecurityGroups : [ 'iTrust-Charlie' ]
                                };
                                    ...
                                    else
                                    {
                                        ...
                                        setTimeout(function()
                                        {
                                            var createTagsParams =
                                            {
                                                ...
                                                Tags : [ { Key : 'Name', Value : 'iTrust-Charlie' } ]
                                            };
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            EC2.associateAddress(associateAddressParams, function(err, data)
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    fs.writeFile('/home/ubuntu/JenkinsDeploy/itrust-charlie.key', privateKey, function(err)
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            fs.chmod('/home/ubuntu/JenkinsDeploy/itrust-charlie.key', 0600, function(err)
                                                                            {
                                                                    ...
                                                                    if (fs.existsSync('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory'))
                                                                    {
                                                                        fs.open('/home/ubuntu/JenkinsDeploy/itrust-cluster-inventory', 'a', function(err)
                                                                        {
                                                                            ...
                                                                            inventoryItem += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-charlie.key`;
                                                                    ...
                                                                    else
                                                                    {
                                                                        ...
                                                                        inventory += ` ansible_ssh_private_key_file=/home/ubuntu/JenkinsDeploy/itrust-charlie.key`;
