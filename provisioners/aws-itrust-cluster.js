...
{
    console.log(`Beginning EC2 provisioning of iTrusts-${instance}...\n`);

    var createKeyPairParams = { KeyName : `iTrust-${instance}` };
    ...
    EC2.createKeyPair(createKeyPairParams, function(err, data)
    {
        ...
        else
        {
            ...
            {
                Description : `iTrust-${instance}`,
                GroupName : `iTrust-${instance}`
            };
                        ...
                        EC2.authorizeSecurityGroupIngress(authorizeSecurityGroupIngressParams, function(err, data)
                        {
                            ...
                            else
                            {
                                ...
                                var runInstanceParams =
                                {
                                    ...
                                    MinCount : 1,
                                    MaxCount : 1,
                                    KeyName : `iTrust-${instance}`,
                                    SecurityGroups : [ `iTrust-${instance}` ]
                                };
                                    ...
                                    else
                                    {
                                        ...
                                        setTimeout(function()
                                        {
                                            var createTagsParams =
                                            {
                                                ...
                                                Tags : [ { Key : 'Name', Value : `iTrust-${instance}` } ]
                                            };
                                                        ...
                                                        else
                                                        {
                                                            ...
                                                            EC2.associateAddress(associateAddressParams, function(err, data)
                                                            {
                                                                ...
                                                                else
                                                                {
                                                                    ...
                                                                    fs.writeFile(`/home/ubuntu/JenkinsDeploy/itrust-${instance}.key`, privateKey, function(err)
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            fs.chmod(`/home/ubuntu/JenkinsDeploy/itrust-${instance}.key`, 0600, function(err)
                                                                            {
